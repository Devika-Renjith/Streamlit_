...
dataset = pd.read_csv(r'C:\Users\HP\Desktop\Streamlit App\Streamlit App\MODELS\SMSSpamCollection.csv', sep='\t', names=['label', 'message'])
...
def plot_confusion_matrix(y_true, y_pred):
    ...
    plt.savefig(r'C:\Users\HP\Desktop\Streamlit App\Streamlit App\MODELS\LSTM\images\test.jpg')
